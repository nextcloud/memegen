...
var render = function render() {
  ...
  }, [_vm.richObject.alt !== null ? _c("strong", [_vm._v("\n\t\t\t" + _vm._s(_vm.richObject.alt) + "\n\t\t")]) : _vm._e(), _vm._v(" "), !_vm.isLoaded ? _c("div", {
...
.memegen-meme-reference .meme-wrapper[data-v-e6a39f56] {
  width: 100%;
  display: flex;
...
.memegen-meme-reference .meme-wrapper .image[data-v-e6a39f56] {
  max-height: 300px;
  max-width: 100%;
  border-radius: var(--border-radius);
  margin-top: 8px;
}
.memegen-meme-reference .meme-wrapper .attribution[data-v-e6a39f56] {
  position: absolute;
  left: 0;
  bottom: 0;
  height: 33px;
...
.memegen-meme-reference .meme-wrapper .attribution .content[data-v-e6a39f56] {
  height: 33px;
  width: 33px;
...
//# sourceMappingURL=memegen-reference-lazy.js.map?v=f5005c40e6b42140211a