...
/* harmony import */ var vue_infinite_loading__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! vue-infinite-loading */ "./node_modules/vue-infinite-loading/dist/vue-infinite-loading.js");
/* harmony import */ var vue_infinite_loading__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(vue_infinite_loading__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _nextcloud_vue_dist_Directives_Tooltip_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @nextcloud/vue/dist/Directives/Tooltip.js */ "./node_modules/@nextcloud/vue/dist/Directives/Tooltip.js");
/* harmony import */ var _nextcloud_vue_dist_Directives_Tooltip_js__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_nextcloud_vue_dist_Directives_Tooltip_js__WEBPACK_IMPORTED_MODULE_10__);
...
vue__WEBPACK_IMPORTED_MODULE_11__["default"].directive('tooltip', (_nextcloud_vue_dist_Directives_Tooltip_js__WEBPACK_IMPORTED_MODULE_10___default()));
const LIMIT = 20;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    InfiniteLoading: (vue_infinite_loading__WEBPACK_IMPORTED_MODULE_9___default()),
  ...
  data() {
    return {
      ...
      poweredByImgSrc: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_7__.imagePath)('integration_giphy', 'powered-by-giphy.gif'),
      poweredByTitle: t('integration_giphy', 'Powered by Giphy'),
      LIMIT,
      sadGifUrl: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_7__.imagePath)('integration_giphy', 'sad.gif')
    };
  },
  computed: {},
  watch: {},
  ...
  methods: {
    ...
    onInput() {
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_8__.delay)(() => {
        this.updateSearch();
      }, 500)();
    },
    onClear() {
    ...
    search(state = null, limit = LIMIT) {
      ...
      this.searching = true;
      const url = this.offset === null ? (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_7__.generateUrl)('apps/memegen/search?term={term}&limit={limit}', {
        term: this.searchQuery,
        limit
      }) : (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_7__.generateUrl)('apps/memegen/search?term={term}&offset={offset}&limit={limit}', {
        term: this.searchQuery,
        offset: this.offset,
        limit
      });
      return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_6__["default"].get(url, {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("NcTextField", {
      ...
      on: {
        "update:value": event => _vm.onCapChange(n, event)
      }
    }, [_c("MagnifyIcon", {
      attrs: {
        size: 16
...
//# sourceMappingURL=memegen-reference-picker-lazy.js.map?v=b283ffb2a105120c8f6a